        ...
        <form id="add-form" method="post">
            <table cellpadding="5">
                ...
                <tr>
                    <td>所属分类:</td>
                    <td>
                        <input id="edit-parentId" class="easyui-combobox" name="categoryId" style="width:100%;" data-options="
                ...
                <tr>
                    <td>新闻封面:</td>
                    <td>
                        <input class="wu-text easyui-textbox easyui-validatebox" type="text" id="add-photo" name="photo" readonly="readonly" value="/images/user_photo.jpg" data-options="required:true,missingMessage:'请上传封面'"></input>
