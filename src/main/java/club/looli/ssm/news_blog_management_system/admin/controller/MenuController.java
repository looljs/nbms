...
import club.looli.ssm.news_blog_management_system.admin.service.MenuService;
...
public class MenuController {
    ...
    public Map<String,String> add(Menu menu){
        ...
        if (StringUtils.equals("",menu.getName())||StringUtils.equals("",menu.getIcon())){
            map.put("type","error");
            map.put("msg","系统错误");
            return map;
        }
    ...
    @RequestMapping(value = "/add_btn",method = RequestMethod.POST)
    @ResponseBody
    public Map<String,String> addBtn(Menu menu){
        Map<String,String> map = new HashMap<>();
        if (menu == null){
            map.put("type","error");
            map.put("msg","系统错误");
